...
'''
git log --oneline -M --stat --follow --pretty="%aI, %s, %an, %ae" -- arquivo1.c
'''
...
filename = '/home/wagner/GitHub/files_txt/sqlite3.txt'
...
create_csv(date_log, authors, commmits, insertions, deletions, 'sqlite3')
